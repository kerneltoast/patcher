...
wget -q https://github.com/CyanogenMod/android_frameworks_av/commit/df1c503b9dac70cd9b1c433215eea7661b5925da.patch
patch -p1 -s < df1c503b9dac70cd9b1c433215eea7661b5925da.patch
git clean -f -d
